    ...
    <div style={{ minHeight: '100vh', display: 'flex', alignItems: 'center', justifyContent: 'center', padding: '20px' }}>
      <div style={{ width: '100%', maxWidth: '400px' }}>
        <div style={{ textAlign: 'center', marginBottom: '32px' }}>
          ...
          <p style={{ color: 'var(--color-text-muted)' }}>Sign in to your Conch account</p>
        </div>
          ...
          <form onSubmit={handleSubmit}>
            <div style={{ marginBottom: '20px' }}>
              ...
              <input
                ...
                style={{ width: '100%', padding: '12px 16px', background: 'var(--color-bg-elevated)', border: '1px solid var(--color-border)', borderRadius: 'var(--radius-lg)', color: 'var(--color-text)', fontSize: '16px', boxSizing: 'border-box' }}
              />
            </div>
